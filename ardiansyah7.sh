...
vps="aneka";
	...
	#source="http://"
#else
	source="https://raw.githubusercontent.com/yusuf-ardiansyah/yusuf"
#fi
...
echo "<pre>Modified by YUSUF-ARDIANSYAH / BLANGKON</pre>" > /home/vps/public_html/index.html
...
# info
clear
echo "Autoscript Edited YUSUF-ARDIANSYAH / BLANGKON:" | tee log-install.txt
...
echo "Credit to all developers script, YUSUF-ARDIANSYAH / BLANGKON" | tee -a log-install.txt
